...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="white-box">
                    <h3 class="box-title">Topup Balance</h3>
                    <div class="panel-body">
                        <form action="{{ route('updateTopupBalance') }}" enctype="multipart/form-data" method="post">
                            {{ method_field("POST") }}
                            @csrf
                            <input type="hidden" name="user_id" @if(isset($data['user']['0']['id'])) value="{{$data['user']['0']['id']}}" @endif>
                            <div class="col-md-6 form-group">
                                <label>Topup Amount </label>
                                <input type="text" name="topup_amount" placeholder="Enter amount here" class="form-control" required="required">
                            </div>
                        ...
                        <table class="table no-wrap">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Roi</th>
