            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="{{route('dashboard')}}">
                        ...
                        <!-- <b> -->
                        <!--This is dark logo icon--><img src="{{ asset('assets/images/logo.webp') }}?v={{time()}}" style="height: 25px;margin-top:15px;" alt="home" class="dark-logo" /><!--This is light logo icon-->
                        ...
                        <img src="{{ asset('assets/images/logo.webp') }}?v={{time()}}" style="height: 25px;" alt="home" class="light-logo">
                        <!-- </span> -->
                    </a>
                </div>
                <!-- /Logo -->
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0);" aria-haspopup="true" aria-expanded="false">
                            <img src="{{ asset('assets/images/logo.webp') }}?v={{time()}}" alt="user-img" width="36" class="img-circle">
                        ...
                        <ul class="dropdown-menu dropdown-user animated123 flipInY123">
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><img src="{{ asset('assets/images/logo.webp') }}?v={{time()}}" alt="user" /></div>
                                    <div class="u-text">
