        ...
        <div class="row">
            <div class="white-box">
                <div class="panel-body">
                    ...
                    @endphp
                    <form action="{{ route('news.update', $editData['id']) }}" enctype="multipart/form-data" method="post">
                    	{{ method_field("PUT") }}
                    @else
                        ...
                        <table id="example" class="table table-striped">
                                    ...
                                    @if(isset($data['data']))
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$pvalue['views']}}</td>
                                            <td><a href="{{ route('news.edit',$pvalue['id'])}}"><button style="float:left;" type="button" class="btn btn-info btn-outline btn-circle btn m-r-5"><i class="ti-pencil-alt"></i></button></a>
                                            <form action="{{ route('news.destroy', $pvalue['id'])}}" method="post">
                                            @csrf
                                            @method('DELETE')
