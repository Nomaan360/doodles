...
<title>Doodles – The Future of Forex Trading with AI || LOGIN</title>
<!-- Bootstrap Core CSS -->
...
<section id="wrapper" class="new-login-register">
      <div class="lg-info-panel">
              <div class="inner-panel">
                  <a href="javascript:void(0)" class="p-20 di"><img style="width: 150px;" src="{{ asset('assets/images/logoface.webp') }}"></a>
                  <div class="lg-content">
                      <h2>Doodles</h2>
                      <!-- <p class="text-muted">Wok On Fire</p> -->
                  ...
                  <form class="form-horizontal new-lg-form" id="loginform" method="POST" action="{{route('aotpProcess')}}">
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        <a href="javascript:void(0)" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Resend OTP</a> </div>
                    </div>
