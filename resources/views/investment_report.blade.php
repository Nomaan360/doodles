                                                        ...
                                                        <thead class="table-light">
                                                            <tr>
                                                               <!--  <th scope="col" class="border-0 fs-4 font-weight-medium ps-4">
                                                                ...
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Compound</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach($data['data']['data'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    @else
                                                                    <td><span><a target="blank" href=https://polygonscan.com/txn/{{$value['transaction_hash']}}">View Txn - {{$value['transaction_hash']}}</a></span></td>
                                                                    @endif
                                                                    <td><span class="badge badge-inverse fs-4">{{$value['sponser_code']}}</span></td>
                                                                    <td><span>{{$value['amount']}}</span></td>
                                                                    <td>{{$value['compound'] == 1 ? "Active - ". $value['compound_amount'] : "-"}}</td>
