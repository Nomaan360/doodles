...
<section class="w-full p-3 md:p-8 mx-auto max-w-[1400px]">
    <h2 class="bg-gradient-to-r from-indigo-300 to-cyan-300 relative text-black rounded-sm p-3 text-lg font-normal leading-none mb-5 flex items-center gap-2">Genealogy</h2>
