    ...
    <div class="grid grid-cols-1 xl:grid-cols-4">
            ...
            <div class="cols-span-1 grid grid-cols-1">
                <div class="p-4 rounded-xl w-full mx-auto border border-[#16204a] bg-[#101735] relative w-full h-full">
                    ...
                    <form class="" method="post" action="{{ route('fprofileUpdate') }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="relative border border-[#000000] p-px rounded-lg flex items-center justify-between bg-gradient-to-br from-yellow-500 via-pink-500 to-blue-500">
                            <div class="flex items-center space-x-3 w-full bg-[#101735] rounded-md p-4">
                                <img src="http://localhost:8000/assets/images/logoface.webp" width="64" height="64" alt="Logo" class="w-16 h-auto">
                                <div class="w-full">
                                    <h3 class="text-lg text-white mb-2 leading-none">User Profile</h3>
                                    <div class="mx-auto">
                                        <input type="file" name="file" class="block w-full text-sm file:mr-4 file:rounded-md file:border-0 file:bg-[#6a8539] file:py-2.5 file:px-4 file:text-sm file:font-semibold file:text-white hover:file:bg-[#6a8a2f] focus:outline-none disabled:pointer-events-none disabled:opacity-60" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="space-y-4 w-full flex-1 mt-4 text-center mx-auto space-y-4">
                            <div class="text-left">
                                ...
                                <div class="relative flex items-center justify-between border border-white border-opacity-5 p-3 rounded gap-3 bg-[#131c45]">
                            ...
                            <div class="text-left">
                                ...
                                <div class="relative flex items-center justify-between border border-white border-opacity-5 p-3 rounded gap-3 bg-[#131c45]">
                                    <input type="text" id="mobile_number" name="mobile_number" value="{{$data['data']['mobile_number']}}" placeholder="Enter Mobile Number" class="border-white border-opacity-15 outline-none shadow-none bg-transparent w-full block text-base" aria-describedby="hs-validation-name-success-helper">
                            ...
                            <div class="flex items-center justify-center py-2 sm:py-4 relative group">
                                <button class="w-full max-w-fit relative inline-block p-px font-semibold leading-none text-white cursor-pointer rounded-full" type="submit">
        ...
        <div class="grid-cols-1 grid gap-5 hidden">
            <div class="p-4 rounded-xl w-full mx-auto border border-[#16204a] bg-[#101735] relative">
                <div class="p-4 rounded-xl w-full mx-auto border border-[#16204a] bg-[#101735] relative overflow-hidden space-y-4 rankinginfo mb-6">
                    <div class="bg-black bg-opacity-35 relative border border-[#000000] border-opacity-10 p-4 rounded-lg flex items-center justify-between">
                        <div class="flex flex-wrap sm:flex-nowrap items-center sm:space-x-3 w-full">
                            <img src={{ asset('assets/images/logoface.webp') }} width="64" height="48" alt="Logo" class="w-12 h-auto">
                            <div class="w-full mt-2 sm:mt-0">
                                <h3 class="text-base mb-2 leading-none">Doodles Referral Link</h3>
                ...
                <form method="post" action="{{ route('fpasswordUpdate') }}" class="space-y-4">
                    ...
                    <div class="flex items-center justify-center my-4 sm:my-8 relative group">
                        <button class="w-full max-w-fit relative inline-block p-px font-semibold leading-none text-white cursor-pointer rounded-full">
                            <span class="absolute inset-0 rounded-full bg-gradient-to-br from-yellow-500 via-pink-500 to-blue-500 p-[2px]"></span>
                            <span class="relative z-10 block px-6 py-3 rounded-sm">
                                <div class="relative z-10 flex items-center space-x-2 justify-center">
