...
<section class="w-full p-3 md:p-8 mx-auto max-w-[1400px]">
    <div class="grid grid-cols-1 xl:grid-cols-4 gap-5">
        ...
        <!-- Network Choose -->
        <div id="networkChoose" class="cols-span-1 xl:col-span-2 relative border border-[#1d2753] p-4 rounded-lg shadow-md flex items-center justify-between text-left">
            <div class="w-full">
                <h3 class="font-semibold text-xl md:text-2xl mb-4">Choose Network</h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div onclick="chooseCoin('evm', 'eth')" class="relative cursor-pointer border border-[#1d2753] rounded-2xl flex items-center justify-between text-left">
                        <div class="flex items-center space-x-3 w-full gap-1 bg-[#101735] rounded-2xl p-4 h-full">
                            <img src={{ asset('assets/images/coin-icon/eth.png') }} width="64" height="48" alt="ETH" class="w-10 sm:w-14 h-auto">
                            <div class="w-full">
                                <h3 class="text-base mb-2 opacity-75 leading-none">ETH</h3>
                            </div>
                        </div>
                    </div>
                    <div onclick="chooseCoin('evm', 'bsc')" class="relative cursor-pointer border border-[#1d2753] rounded-2xl flex items-center justify-between text-left">
                        <div class="flex items-center space-x-3 w-full gap-1 bg-[#101735] rounded-2xl p-4 h-full">
                            <img src={{ asset('assets/images/coin-icon/bsc.png') }} width="64" height="48" alt="BSC" class="w-10 sm:w-14 h-auto">
                            <div class="w-full">
                                <h3 class="text-base mb-2 opacity-75 leading-none">BSC</h3>
                            </div>
                        </div>
                    </div>
                    <div onclick="chooseCoin('evm', 'polygon')" class="relative cursor-pointer border border-[#1d2753] rounded-2xl flex items-center justify-between text-left">
                        <div class="flex items-center space-x-3 w-full gap-1 bg-[#101735] rounded-2xl p-4 h-full">
                            <img src={{ asset('assets/images/coin-icon/polygone.png') }} width="64" height="48" alt="POLYGON" class="w-10 sm:w-14 h-auto">
                            <div class="w-full">
                                <h3 class="text-base mb-2 opacity-75 leading-none">POLYGON</h3>
                            </div>
                        </div>
                    </div>
                    <div onclick="chooseCoin('trc', 'tron')" class="relative cursor-pointer border border-[#1d2753] rounded-2xl flex items-center justify-between text-left">
                        <div class="flex items-center space-x-3 w-full gap-1 bg-[#101735] rounded-2xl p-4 h-full">
                            <img src={{ asset('assets/images/coin-icon/trc.png') }} width="64" height="48" alt="TRC" class="w-10 sm:w-14 h-auto">
                            <div class="w-full">
        ...
        <!-- Coin Choose -->
        <div id="coinChoose" style="display: none;" class="cols-span-1 xl:col-span-2 relative border border-[#1d2753] p-4 rounded-lg shadow-md flex items-center justify-between text-left">
            <div class="w-full">
                ...
                <div class="w-full flex-1 mt-4 text-center mx-auto mt-8">
                    <p class="text-red-400 mb-2 text-left text-sm">* Minimum Deposit $20</p>
